...
<body>
	...
	<div class="grid grid-pad" >
		...
		<div class="col-9-12">
				<h1>Commercants</h1>
			<div class="col-9-12">
			<form action="PDOComm.php" method="POST">
				<div class="content">
				<article class="content1">
					<div >
					  <label class="control-label" >Nom</label>
					  <input type="text" class="form-control" placeholder="Nom,Prénom" name="Nom" id="Nom" aria-describedby="helpBlock2">
					...
					<div >
					  ...
					  <input type="text" class="form-control"  placeholder="07xxxxx" name="Telephone" id="Telephone" aria-describedby="helpBlock2">
					  <span id="helpBlock2" class="help-block"></span>
					</div>
					<div >
